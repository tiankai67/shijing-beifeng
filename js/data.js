...
const POEMS = [
  {
    ...
    "fullNotes": [
      "泛舟漂流，耿耿不寐，心怀隐忧，并非无酒可消遣。",
      "我心非镜，难纳一切；虽有兄弟，却不可依傍。",
      "我心非石非席，不可转卷；威仪闲雅，不可拣选。",
      "忧心忡忡，见怨于群小；遭闵受侮，夜半抚胸长叹。",
      "日月光微，忧如未浣之衣；静思难解，不能奋飞。"
    ]
  },
  {
    "id": 2,
  ...
  },
  {
    ...
    "fullNotes": [
      "日月照临，彼人不再故处，何能安定？宁不顾我？",
      "日月覆地，彼人不相好，何能安定？宁不报我？",
      "日月出东，彼人德音无良，何能安定？俾亦可忘。",
      "日月东出，父母畜我不终，何能安定？报我不述。"
    ]
  },
  {
    "id": 5,
  ...
  },
  {
    ...
    "fullNotes": [
      ...
      "泾以渭浊，宴尔新婚，不我屑以；毋逝我梁。",
      "就其深浅，方舟泳游；凡民有丧，匍匐救之。",
      "不我能慉，反以我为雠；既生既育，比予于毒。",
      "我有旨蓄御冬，宴尔新婚，以我御穷；不念昔者。"
    ]
  },
  {
    "id": 11,
  ...
  },
  {
    ...
    "fullNotes": [
      "毖彼泉水亦流于淇，有怀于卫靡日不思，聊与诸姬谋。",
      "出宿于泲，饮饯于祢；女子有行，远父母兄弟。",
      "出宿于干，饮饯于言；载脂载辖，遄臻于卫。",
      "我思肥泉兹之永叹，思须与漕，驾言出游以写忧。"
    ]
  },
  {
    "id": 15,
